...
void MPU9250::shutdown()
{
  ...
  uint8_t c;
  readRegisters(PWR_MGMNT_1, 1, &c);
  // Serial.println(c);
  // delay(10);
  writeRegister(PWR_MGMNT_1, c | 0x40); // Set sleep mode bit (6), disable all sensors
  delay(5);
  // writeAK8963Register(AK8963_CNTL1, AK8963_PWR_DOWN);
  delay(5);
  readRegisters(PWR_MGMNT_1, 1, &c);
  delay(5);
  // Serial.println(c);
  // writeRegister(PWR_MGMNT_1, c | 0x10);
  
  delay(5);
  readRegisters(PWR_MGMNT_1, 1, &c);
  // Serial.println(c);
  // writeRegister(PWR_MGMNT_1, 0x40); // Set sleep mode bit (6), disable all sensors
